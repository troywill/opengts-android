* [13/15] Step by step installation
  ...
  4. [X] Install JDBC
     ...
     5. [X] sudo pacman --upgrade mysql-jdbc-5.1.29-1-i686.pkg.tar.xz
     6. [X] copy 
  ...
  12. [X] Install track.war
      ...
      2. [X] Copy track.war
         ...
         #+END_SRC
  13. [X] Install events.war Java servlet
      1. [X] Compile events.war" Java servlet
         #+BEGIN_SRC sh
           cd $GTS_HOME && ant events
         #+END_SRC
      2. [X] Install events.war
         #+BEGIN_SRC sh
      ...
      3. [X] Test the installation
         ...
         #+END_SRC
      4. [X] http://localhost:8080/track/Track
	 + Account :: sysadmin
	 + User :: (blank)
	 + Password :: password
